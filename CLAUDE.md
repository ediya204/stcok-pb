...
### Brand Personality
- Personality keywords: **trustworthy**, **premium**, **fast**, **technical**, with a **friendly** and slightly **playful** modern tone.
- Emotional goals: help users feel **confident** and **in control**, while keeping the experience **lightweight** and **efficient**.

### Aesthetic Direction
- Keep and evolve the **current design language**:
  - Modern finance UI with **large rounded corners**, **strong typography**, **layered cards**, and **subtle glass/blur** where appropriate.
  - Use motion for clarity (state changes, overlays) without feeling “gimmicky”.
...
2. **Semantic color discipline**: blue for primary actions/links, green/red strictly for up/down and success/error semantics.
